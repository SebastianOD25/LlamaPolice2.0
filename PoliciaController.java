...
public class PoliciaController {
	...
	@RequestMapping("/")
	public String irPaginaListadoPolicia(Map<String, Object> model) {
		model.put("listaPolicia", pService.listar());
		return "listPolicia";
	}
	...
	*/
	...
	throws ParseException{
		pService.listarId(fiscal.getIdFiscal());
		return "listPolicia";
	}
}
