...
public class JpaUsuarioDetailsService implements UserDetailsService{
	...
	public UserDetails loadUserByUsername(String usercode) throws UsernameNotFoundException{
		Usuarios usuario = UsuarioRep.findByUsercode(usercode);
		List<GrantedAuthority>authorities = new ArrayList<GrantedAuthority>();
		
		authorities.add(new SimpleGrantedAuthority(usuario.getIdRol().getAuthority()));

		UserDetails uD = new User(usuario.getUsercode(), usuario.getPassword(), authorities);
